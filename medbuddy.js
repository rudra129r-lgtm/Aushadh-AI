...
const TRANSLATIONS = {
  dashboard: {
    ...
    upload_summary_desc: { en: 'Upload your prescription or discharge summary. Our AI extracts every detail and explains it in plain language you can understand.', hi: 'अपना नुस्खा या डिस्चार्ज सारांश अपलोड करें। हमारी AI हर detail निकालकर आपको सरल भाषा में समझाएगी।' },
    feature_plain_diagnosis: { en: 'Plain-language diagnosis', hi: 'सरल भाषा में निदान' },
    feature_exact_dosages: { en: 'Exact dosages', hi: 'सही खुराक' },
    feature_side_alerts: { en: 'Side effect alerts', hi: 'साइड इफेक्ट अलर्ट' },
